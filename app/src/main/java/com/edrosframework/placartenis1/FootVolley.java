...
//--------------------------------------------------------------------------------------------------
public class FootVolley extends Scoreboard {
    ...
    // MAIN CONSTRUCTOR
    //----------------------------------------------------------------------------------------------
    public FootVolley(ScoreParameters set_rules) {
        super(set_rules);
        Restart();
    }
    ...
    private void SetIncrement(int player_id, int n) {
        ...
        // footvolley specifics
        //if(current_set == SET_3){ points_to_win = Rules.points_matchTiebreak; this. court_switch = 5;}

        // footvolley specifics (TIEBREAK DETECTION)
    ...
    private void Increment(int player_id) {
        ...
        setCurrentServer((byte) player_id);
