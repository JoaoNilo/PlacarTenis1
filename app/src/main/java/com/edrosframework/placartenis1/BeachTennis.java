...
//--------------------------------------------------------------------------------------------------
public class BeachTennis extends Scoreboard {
    ...
    // MAIN CONSTRUCTOR
    //----------------------------------------------------------------------------------------------
    public BeachTennis(ScoreParameters set_rules) {
        super(set_rules);
        Restart();
    }
    ...
    private void TennisTiebreak(int player_id) {
        ...
        if(game == player_id){
            ...
            if(Rules.alternate_service) {
                ...
                if (((player_points[player_id] + player_points[player_nid]) == 1)||
                        (((player_points[player_id] + player_points[player_nid]) % 4) == 0)) {
